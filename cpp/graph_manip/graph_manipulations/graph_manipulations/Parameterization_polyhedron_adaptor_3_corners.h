...
#ifndef CGAL_PARAMETERIZATION_POLYHEDRON_ADAPTOR3_H_CORN
#define CGAL_PARAMETERIZATION_POLYHEDRON_ADAPTOR3_H_CORN
...
#include <list>
#include <vector>
/// \file Parameterization_polyhedron_adaptor_3_corners.h
...
///
/// `Parameterization_polyhedron_adaptor_3_corners` is an adaptor class to access to a Polyhedron
...
class Parameterization_polyhedron_adaptor_3_corners
{
// Forward references
public:
...
public:
    ...
    //*******************************************************************
    // @name Interface specific to Parameterization_polyhedron_adaptor_3_corners
    //*******************************************************************
    //@{
    ...
    //@} // end of Interface specific to Parameterization_polyhedron_adaptor_3_corners
...
public:
    ...
    /// It can have have any number of borders. Its "main border"
    /// will be the mesh's longest border (if there is at least one border).
    Parameterization_polyhedron_adaptor_3_corners(Polyhedron& mesh)
...
private:
    ...
    struct Project_halfedge_vertex {
        ...
        typedef typename Parameterization_polyhedron_adaptor_3_corners::Vertex
                                                    Vertex;
...
}; // Parameterization_polyhedron_adaptor_3_corners
