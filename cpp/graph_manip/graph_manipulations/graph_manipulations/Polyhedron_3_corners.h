...
#ifndef CGAL_POLYHEDRON_3_H_CORN
#define CGAL_POLYHEDRON_3_H_CORN
...
public:
    ...
    typedef Polyhedron_3_corners< PolyhedronTraits_3, PolyhedronItems_3, T_HDS, Alloc>
                                                  Self;
...
public:
    ...
    Polyhedron_3_corners( const Traits& trts = Traits()) : m_traits(trts) {}
        // the empty polyhedron `P'.

    Polyhedron_3_corners( size_type v, size_type h, size_type f,
